...
/** Immutable Java copy of a standard encoded region handle. */
final class NativeRegionHandle implements RegionHandle {
   private final byte[] encoded;

   NativeRegionHandle(byte[] value) {
      encoded = value.clone();
   }
   ...
   public boolean equals(Object other) {
      if (!(other instanceof RegionHandle)) return false;
      RegionHandle candidate = (RegionHandle) other;
