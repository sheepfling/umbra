...
std::auto_ptr<DataElement> HLAvariableArray::clone() const {
  return std::auto_ptr<DataElement>(new HLAvariableArray(*this));
}
...
void HLAvariableArray::decode(VariableLengthData const& value) {
...
void HLAvariableArray::set(std::size_t index, DataElement const& dataElement) {
...
void HLAvariableArray::setElementPointer(
    std::size_t index,
