...
#include "../generated/rti_ambassador_shell_2010.hpp"

namespace rti1516e {

Exception::Exception() = default;
Exception::Exception(Exception const& rhs) = default;
Exception& Exception::operator=(Exception const& rhs) = default;
Exception::~Exception() = default;
...
#define RTI_EXCEPTION(name)                    \
  name::name(std::wstring const& message)      \
      throw()                                  \
      : _msg(message) {}                       \
  std::wstring name::what() const throw() {    \
    return _msg;                               \
  }
...
RTIambassador::RTIambassador() throw() = default;
RTIambassador::~RTIambassador() = default;

FederateAmbassador::FederateAmbassador() throw(FederateInternalError) = default;
FederateAmbassador::~FederateAmbassador() throw() = default;

LogicalTime::~LogicalTime() throw() = default;
LogicalTimeInterval::~LogicalTimeInterval() throw() = default;
LogicalTimeFactory::~LogicalTimeFactory() throw() = default;

std::wstring rtiName() { return L"Umbra IEEE 1516.1-2010 reference RTI"; }

std::wstring rtiVersion() { return L"0.2.0-reference"; }

RTIambassadorFactory::RTIambassadorFactory() = default;
RTIambassadorFactory::~RTIambassadorFactory() throw() = default;

std::auto_ptr<RTIambassador> RTIambassadorFactory::createRTIambassador()
    throw(RTIinternalError) {
  return std::auto_ptr<RTIambassador>(new umbra_binding_detail::RtiAmbassadorShell());
}
