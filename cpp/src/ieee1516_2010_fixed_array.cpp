...
std::auto_ptr<DataElement> HLAfixedArray::clone() const {
  return std::auto_ptr<DataElement>(new HLAfixedArray(*this));
}
...
void HLAfixedArray::decode(VariableLengthData const& value) {
...
void HLAfixedArray::set(std::size_t index, DataElement const& dataElement) {
...
void HLAfixedArray::setElementPointer(std::size_t index, DataElement* dataElement) {
