...
#error "The timed save/restore pending ownership cancellation test requires the Umbra source directory."
#endif
...
std::wstring nextFederationName() {
  ...
  return L"timed-live-tso-regional-attribute-multi-recipient-cancel-pending-ownership-" +
...
TEST_CASE(
    "Embedded timed multi-recipient regional timestamped attribute update survives requester cancellation of pending ownership acquisition after restore",
    ...
    "[cancel-pending-ownership-acquisitions][timestamped-regional-attribute-update][explicit-source]"
