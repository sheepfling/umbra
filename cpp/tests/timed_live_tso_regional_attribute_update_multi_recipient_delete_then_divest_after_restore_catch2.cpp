...
#error "The timed save/restore delete-then-divest test requires the Umbra source directory."
#endif
...
std::wstring nextFederationName() {
  ...
  return L"timed-live-tso-regional-attribute-multi-recipient-delete-then-divest-" +
...
TEST_CASE(
    "Embedded timed multi-recipient regional timestamped attribute update is suppressed after delete-then-divest resignation following restore",
    ...
    "[delete-then-divest][timestamped-regional-attribute-update][explicit-source]"
    "[mixed-fanout][tso-regional-attribute-update-timed-delete-state]"
  ...
  std::wstring const saveLabel =
      L"restore-live-explicit-source-regional-delete-then-divest";
  ...
  // DELETE_OBJECTS_THEN_DIVEST is a receive-order removal at each recipient's
