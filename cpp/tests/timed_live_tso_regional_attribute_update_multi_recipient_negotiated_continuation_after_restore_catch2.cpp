...
std::wstring nextFederationName() {
  ...
  return L"timed-live-tso-regional-attribute-multi-recipient-negotiated-continuation-" +
...
TEST_CASE(
    "Embedded timed multi-recipient regional timestamped attribute update continues to a retained negotiated ownership candidate after restore",
    ...
    "[tso-regional-attribute-update-timed-negotiated-continuation-after-restore]"
  ...
  std::wstring const saveLabel =
      L"restore-live-explicit-source-regional-negotiated-continuation";
