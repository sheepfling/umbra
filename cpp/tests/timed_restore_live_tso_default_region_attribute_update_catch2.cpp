...
#error "The timed save/restore default-region attribute tests require the Umbra source directory."
#endif
...
std::wstring nextFederationName() {
  ...
  return L"timed-restore-live-tso-default-region-attribute-" +
...
TEST_CASE(
    "Embedded timed federation restore restores a live timestamped default-region attribute update at the save boundary",
    "[integration][development-profile][federation-management][save-restore]"
    "[timed-save][object-management][ddm][time-management][tso]"
    "[timestamped-default-region-attribute-update][default-region][timestamped-default-region-attribute-timed-restore]"
  ...
  unsigned char const valueBytes[] = {0x44, 0x45, 0x46, 0x2D, 0x41, 0x54, 0x54};
  ...
  std::wstring const saveLabel = L"timed-live-default-region-attribute-save";
  ...
  REQUIRE_NOTHROW(publisherHandle = publisher->joinFederationExecution(
      L"timed-live-default-region-attribute-publisher",
      L"publisher",
      federationName));
  REQUIRE_NOTHROW(receiver->joinFederationExecution(
      L"timed-live-default-region-attribute-receiver",
      L"subscriber",
      federationName));
