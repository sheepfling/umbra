...
TEST_CASE("The private federate lifecycle accepts the modeled top-level paths", "[unit][kernel][lifecycle][foundation][federation-management]") {
...
TEST_CASE("The private federate lifecycle rejects transitions outside their source state", "[unit][kernel][lifecycle][foundation][federation-management]") {
  FederateLifecycle lifecycle;
...
TEST_CASE("The private federate lifecycle retains connection after RTI-initiated resignation", "[unit][kernel][lifecycle][foundation][federation-management]") {
  FederateLifecycle lifecycle;
