...
std::wstring nextFederationName() {
  ...
  return L"restore-live-tso-regional-interaction-multi-recipient-" +
...
TEST_CASE(
    "Embedded federation restore restores one queued timestamped regional interaction to multiple recipients",
    "[integration][development-profile][federation-management][save-restore]"
    "[interaction-management][ddm][time-management][tso]"
    "[timestamped-regional-interaction][explicit-source][mixed-fanout]"
    "[multi-federate-callback-ordering]"
    "[timestamped-regional-interaction-restore-multi-recipient]"
  ...
  REQUIRE_NOTHROW(firstReceiver->subscribeInteractionClassWithRegions(
      interactionClass,
      RegionHandleSet{firstReceiverRegion}));
  REQUIRE_NOTHROW(secondReceiver->subscribeInteractionClassWithRegions(
      interactionClass,
      RegionHandleSet{secondReceiverRegion}));
  ...
  REQUIRE_NOTHROW(firstReceiver->unsubscribeInteractionClassWithRegions(
      interactionClass,
      RegionHandleSet{firstReceiverRegion}));
  REQUIRE_NOTHROW(secondReceiver->unsubscribeInteractionClassWithRegions(
      interactionClass,
      RegionHandleSet{secondReceiverRegion}));
