...
#error "The timed save/restore pending If Available ownership cancellation test requires the Umbra source directory."
#endif
...
std::wstring nextFederationName() {
  ...
  return L"timed-live-tso-regional-attribute-multi-recipient-if-available-cancel-pending-ownership-" +
...
TEST_CASE(
    "Embedded timed multi-recipient regional timestamped attribute update survives requester cancellation of pending If Available ownership acquisition after restore",
    ...
    "[cancel-pending-ownership-acquisitions][attribute-ownership-acquisition-if-available][timestamped-regional-attribute-update][explicit-source]"
  ...
  std::wstring const saveLabel =
      L"restore-live-explicit-source-regional-if-available-cancel-pending-ownership";
