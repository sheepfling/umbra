...
// candidate, and cancellation after the owner's confirmation callback.
#define UMBRA_REGULAR_CANDIDATE_TEST_CASE(...) \
  void umbra_run_mixed_retained_regular_confirmation_cancel()
#define UMBRA_MIXED_CANDIDATE_FIRST_IF_AVAILABLE 1
#define UMBRA_MIXED_CONFIRMATION_CANCEL 1
...
#undef UMBRA_MIXED_CONFIRMATION_CANCEL
#undef UMBRA_MIXED_CANDIDATE_FIRST_IF_AVAILABLE
#undef UMBRA_REGULAR_CANDIDATE_TEST_CASE

TEST_CASE(
    "Embedded timed multi-recipient regional timestamped attribute update cancels mixed retained regular owner confirmation after restore",
    ...
    "[tso-regional-attribute-update-timed-negotiated-retained-regular-confirmation-cancel-after-restore]"
  ...
  REQUIRE_NOTHROW(umbra_run_mixed_retained_regular_confirmation_cancel());
}
